import { ClassGroup, IClassGroupProps } from "@/app/components/course-content/components/ClassGroup";
    ...
    return (
        ...
        <ol className="flex flex-col rounded-lg overflow-clip">
         {classGroups.map(classGroup => (
           ...
           <li key={classGroup.title} className="flex flex-col"><ClassGroup {...classGroup}/></li>
         ))}
        </ol>
        </div>
