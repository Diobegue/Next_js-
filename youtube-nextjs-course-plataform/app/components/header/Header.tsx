...
export const Header = () => {
    ...
    return (
        <>
            <nav className="flex items-center gap-4 justify-start fixed top-0 right-0 left-0 md:justify-center bg-[var(--color-primary)] py-2 sm:py-4 px-6 ">
                ...
                <div
                    ...
                    data-open={drawer} className="sm:hidden bg-gradient-to-r from-black  fixed top-0 left-0 bottom-0 right-0 
